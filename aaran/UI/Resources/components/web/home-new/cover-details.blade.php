<div class="py-8 mt-12">
    ...
    <div class="font-roboto tracking-wider grid sm:gap-10 gap-5 sm:pt-20 pt-0">
        <x-Ui::web.home-new.items.heading label="Billing Made Simple and Efficient" />

        <div class="text-center md:text-6xl text-lg font-semibold">Try India’s easiest GST billing platform</div>

        <div class="grid md:grid-cols-4 grid-cols-1 w-10/12 mx-auto gap-6">
            ...
            <x-Ui::web.home-new.items.cover-card
                ...
                bg_color="bg-[#FEBA35]"
            >
                <x-Ui::web.home-new.icons.pay-rec-cover />
            </x-Ui::web.home-new.items.cover-card>
            ...
            <x-Ui::web.home-new.items.cover-card
                ...
                bg_color="bg-[#464B8B]"
            >
                <x-Ui::web.home-new.icons.report-cover />
            </x-Ui::web.home-new.items.cover-card>
            ...
            <x-Ui::web.home-new.items.cover-card
                ...
                bg_color="bg-[#8E9BA3]"
            >
                <x-Ui::web.home-new.icons.e-inv-cover />
            </x-Ui::web.home-new.items.cover-card>
