<footer class="bg-slate-50">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="py-16">
            <svg aria-hidden="true" viewBox="0 0 109 40" class="mx-auto h-10 w-auto">
        ...
        <div
            ...
            <div class="flex gap-x-6"><a class="group" aria-label="TaxPal on X" href="#">
                ...
                </a><a class="group" aria-label="TaxPal on GitHub" href="#">
                    <svg class="h-6 w-6 fill-slate-500 group-hover:fill-slate-700" aria-hidden="true"
                         viewBox="0 0 24 24">
                        <path
            ...
            <p class="mt-6 text-sm text-slate-500 sm:mt-0">Copyright © <!-- -->2025<!-- --> TaxPal. All rights
                reserved.</p></div>
    </div>
</footer>
