<main>
                    ...
                    <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                        <li class="flex">
                            <img alt="Transistor" loading="lazy" width="158" height="48" decoding="async"
                                 ...
                                 src="{{Storage::url('public/logo/sk-logo.jpeg')}}">
    ...
    <section id="features" aria-label="Features for running your books"
             class="relative overflow-hidden bg-blue-600 pt-20 pb-28 sm:py-32"><img alt="" loading="lazy" width="2245"
                                                                                    height="1636" decoding="async"
                                                                                    data-nimg="1"
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
                ...
                <h2
                    class="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">Everything you need
                    to run your books.</h2>
                <p class="mt-6 text-lg tracking-tight text-blue-100">Well everything you need if you aren’t that picky
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h3>
                                <button
                                    ...
                                    id="headlessui-tabs-tab-:R9d9afja:" role="tab" type="button" aria-selected="true"
                                    tabindex="0" data-headlessui-state="selected" data-selected=""
                                    aria-controls="headlessui-tabs-panel-:R1l9afja:"><span
                                        class="absolute inset-0 rounded-full lg:rounded-l-xl lg:rounded-r-none"></span>Payroll
                                </button>
                            </h3>
                            <p class="mt-2 hidden text-sm lg:block text-white">Keep track of everyone's salaries and
                                whether or not they've been paid. Direct deposit not supported.</p></div>
                        <div
                            ...
                            <h3>
                                <button
                                    ...
                                    id="headlessui-tabs-tab-:Rad9afja:" role="tab" type="button" aria-selected="false"
                            ...
                            <p class="mt-2 hidden text-sm lg:block text-blue-100 group-hover:text-white">All of your
                        ...
                        <div
                            ...
                            <h3>
                                <button
                                    class="font-display text-lg data-selected:not-data-focus:outline-hidden text-blue-100 hover:text-white lg:text-white"
                                    id="headlessui-tabs-tab-:Rbd9afja:" role="tab" type="button" aria-selected="false"
                                    tabindex="-1" data-headlessui-state=""
                            ...
                            <p class="mt-2 hidden text-sm lg:block text-blue-100 group-hover:text-white">We only sell
                                our software to companies who don't deal with VAT at all, so technically we do all the
                                VAT stuff they need.</p></div>
                        <div
                            class="group relative rounded-full px-4 py-1 lg:rounded-l-xl lg:rounded-r-none lg:p-6 hover:bg-white/10 lg:hover:bg-white/5">
                            <h3>
                                <button
                                    class="font-display text-lg data-selected:not-data-focus:outline-hidden text-blue-100 hover:text-white lg:text-white"
                                    id="headlessui-tabs-tab-:Rcd9afja:" role="tab" type="button" aria-selected="false"
                                    tabindex="-1" data-headlessui-state=""
                                    aria-controls="headlessui-tabs-panel-:R4l9afja:"><span
                                        class="absolute inset-0 rounded-full lg:rounded-l-xl lg:rounded-r-none"></span>Reporting
                                </button>
                            </h3>
                ...
                <div class="lg:col-span-7">
                    <div id="headlessui-tabs-panel-:R1l9afja:" role="tabpanel" tabindex="0"
                        ...
                        <div class="relative sm:px-6 lg:hidden">
                            <div
                                class="absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-white/10 ring-inset sm:inset-x-0 sm:rounded-t-xl"></div>
                    ...
                    <div id="headlessui-tabs-panel-:R2l9afja:" role="tabpanel" tabindex="-1" hidden=""
                         style="display:none" data-headlessui-state="" aria-labelledby="headlessui-tabs-tab-:Rad9afja:">
                        <div class="relative sm:px-6 lg:hidden">
                            <div
                                class="absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-white/10 ring-inset sm:inset-x-0 sm:rounded-t-xl"></div>
                    ...
                    <div id="headlessui-tabs-panel-:R3l9afja:" role="tabpanel" tabindex="-1" hidden=""
                         style="display:none" data-headlessui-state="" aria-labelledby="headlessui-tabs-tab-:Rbd9afja:">
                        <div class="relative sm:px-6 lg:hidden">
                            <div
                                class="absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-white/10 ring-inset sm:inset-x-0 sm:rounded-t-xl"></div>
                    ...
                    <div id="headlessui-tabs-panel-:R4l9afja:" role="tabpanel" tabindex="-1" hidden=""
                         style="display:none" data-headlessui-state="" aria-labelledby="headlessui-tabs-tab-:Rcd9afja:">
                        <div class="relative sm:px-6 lg:hidden">
                            <div
                                class="absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-white/10 ring-inset sm:inset-x-0 sm:rounded-t-xl"></div>
