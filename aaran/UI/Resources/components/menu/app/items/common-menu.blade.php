<x-Ui::menu.app.base.li-menuitem  :routes="'cities'" :label="'City'"/>
{{--<x-Ui::menu.app.base.li-menuitem  :routes="'states'" :label="'State'"/>--}}
{{--<x-Ui::menu.app.base.li-menuitem  :routes="'pin-codes'" :label="'Pin codes'"/>--}}
{{--<x-Ui::menu.app.base.li-menuitem  :routes="'countries'" :label="'Countries'"/>--}}
{{--<x-Ui::menu.app.base.li-menuitem  :routes="'hsn-codes'" :label="'Hsn codes'"/>--}}
{{--<x-Ui::menu.app.base.li-menuitem  :routes="'units'" :label="'Units'"/>--}}
