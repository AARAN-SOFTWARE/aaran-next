<div>
    <div class="xl:flex-col w-full gap-2 font-lex text-xs">
        ...
        <div x-data="{isTyped: @entangle('colourTyped')}" @click.away="isTyped = false" class="w-full">

            <div class="relative ">
                <div class="relative font-lex">
                    <input
                        id="colour_name"
                        wire:model.live.debounce="colour_name"
                ...
                @error('colour_name')
                <span
                    class="text-red-500">{{'The Colour is Required.'}}</span>
                @enderror
