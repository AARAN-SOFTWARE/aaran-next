        ...
        <div x-data="{isTyped: @entangle('ledgerTyped')}" @click.away="isTyped = false" class="w-full">
            ...
            <div class="relative ">
                <div class="relative font-lex">
                    <input
                        id="ledger_name"
                        wire:model.live.debounce="ledger_name"
                ...
                @error('ledger_name')
                <span
                    class="text-red-500">{{'The Ledger is Required.'}}</span>
                @enderror
