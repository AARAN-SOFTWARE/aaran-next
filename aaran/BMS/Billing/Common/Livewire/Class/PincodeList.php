...
class PincodeList extends Component
{
    ...
    {
        return [
            'vname' => 'required' . ($this->vid ? '' : "|unique:{$this->getTenantConnection()}.pincodes,vname"),
        ];
    }
    ...
    public function getSave(): void
    {
        ...
        Pincode::on($connection)->updateOrCreate(
            ['id' => $this->vid],
            [
    ...
    {
        return Pincode::on($this->getTenantConnection())
    ...
    public function deleteFunction(): void
    {
        ...
        $obj = Pincode::on($this->getTenantConnection())->find($this->deleteId);
        if ($obj) {
            $obj->delete();
        }
    }
