...
class ContactTypeList extends Component
{
    ...
    {
        return [
            'vname' => 'required' . ($this->vid ? '' : "|unique:{$this->getTenantConnection()}.contact_types,vname"),
        ];
    }
    ...
    public function getSave(): void
    {
        ...
        ContactType::on($connection)->updateOrCreate(
            ['id' => $this->vid],
            [
    ...
    {
        return ContactType::on($this->getTenantConnection())
    ...
    public function deleteFunction(): void
    {
        ...
        $obj = ContactType::on($this->getTenantConnection())->find($this->deleteId);
        if ($obj) {
            $obj->delete();
        }
    }
