        ...
        <div x-data="{isTyped: @entangle('orderTyped')}" @click.away="isTyped = false" class="w-full">
            ...
            <div class="relative ">
                <div class="relative font-lex">
                    <input
                        id="order_name"
                        wire:model.live.debounce="order_name"
                ...
                @error('order_name')
                <span
                    class="text-red-500">{{'The Order No is Required.'}}</span>
                @enderror
