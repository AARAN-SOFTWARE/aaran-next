<div>
    <div class="xl:flex-col w-full gap-2 font-lex text-xs">
        ...
        <div x-data="{isTyped: @entangle('styleTyped')}" @click.away="isTyped = false" class="w-full">

            <div class="relative ">
                <div class="relative font-lex">
                    <input
                        id="style_name"
                        wire:model.live.debounce="style_name"
                ...
                @error('style_name')
                <span
                    class="text-red-500">{{'The Style No is Required.'}}</span>
                @enderror
