            ...
            <x-slot:table_body name="table_body">
                ...
                @foreach($list as $index=>$row)
                    ...
                    <x-Ui::table.row>
                        ...
                        <x-Ui::table.cell-text>{{$row->producttype_id->name}}</x-Ui::table.cell-text>
        ...
        <x-Ui::forms.create :id="$vid">
            ...
            <div class="flex flex-col gap-3">
                ...
                <x-Ui::dropdown.wrapper label="Product Type" type="producttypeTyped">
                    ...
                    <div class="relative">
                        <x-Ui::dropdown.input label="Product Type" id="producttype_name"
                        ...
                        <x-Ui::dropdown.select>
                            @if($producttypeCollection)
                                ...
                                @empty
                                    <x-Ui::dropdown.new wire:click.prevent="productTypeSave('{{$producttype_name}}')"
                                                    label="Product"/>
                                @endforelse
                            @endif
                ...
                <x-Ui::dropdown.wrapper label="GST Percent" type="gstpercentTyped">
                    <div class="relative ">
                        <x-Ui::dropdown.input label="GST Percent" id="gstpercent_name"
                        ...
                        <x-Ui::dropdown.select>
                            @if($gstpercentCollection)
                                ...
                                @empty
                                    <x-Ui::dropdown.new wire:click.prevent="gstPercentSave('{{$gstpercent_name}}')"
                                                    label="GST Percent"/>
                                @endforelse
                            @endif
                    ...
                    <x-Ui::input.error-text wire:model="gstpercent_name"/>
                </x-Ui::dropdown.wrapper>
