<div>
    <div class="xl:flex-col w-full gap-2 font-lex text-xs">
        ...
        <div x-data="{isTyped: @entangle('productTyped')}" @click.away="isTyped = false" class="w-full">

            <div class="relative ">
                <div class="relative font-lex">
                    <input
                        id="product_name"
                        wire:model.live.debounce="product_name"
                ...
                @error('product_name')
                <span
                    class="text-red-500">{{'The Product Name is Required.'}}</span>
                @enderror
