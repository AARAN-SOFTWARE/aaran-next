<div class="bg-gray-200 text-black">
    <div class="grid grid-cols-1 lg:grid-cols-2 py-10 sm:py-25">
        <div class="hidden lg:block p-20 w-[80%] mx-auto bg-white rounded-4xl">
            <div class="text-2xl md:text-3xl block mx-auto text-start font-bold w-[80%]">Trusted by Business and CAs</div>
            <div class="w-[80%] bg-gray-200 block mx-auto p-5 mt-6 rounded-4xl">
                <div class="my-4">
                    <div>Review Review Review Review Review Review Review Review Review Review Review Review Review Review Review Review Review Review Review Review Review shdfk  Review Review Review Review Review Review Review</div>
                </div>
                <div class="flex gap-3">
                    <img src="/images/home/wp1.webp" class="w-10 h-10 rounded-full block my-auto"/>
                    <div>
                        <div>Aaran InfoTech</div>
                        <div>Admin,Software Developer</div>
                    </div>
                </div>
            </div>
            <div class="flex items-center justify-center gap-4 w-full mt-5">
                <hr class="flex-grow border-t border-gray-400">
                <p class="text-gray-700 whitespace-nowrap">Rated By The Best</p>
                <hr class="flex-grow border-t border-gray-400">
            </div>
        </div>
{{--        <div>--}}
