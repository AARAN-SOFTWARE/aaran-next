<div>
    ...
    <div class="flex sm:flex-row flex-col-reverse justify-center font-roboto tracking-wider my-16 gap-6 scroll-smooth">
                ...
                <div class="group flex-col flex border-b gap-y-5">
                    <div class="flex flex-row justify-between ">
                        ...
                        <a href="{{route('posts.show',[$row->id])}}">
                            ...
                            <div class="text-3xl font-semibold font-merri animate__animated wow animate__backInLeft "
                    ...
                    <div class="space-y-5 pb-16">
                            ...
                            <a href="{{route('posts.show',[$row->id])}}">
                                <div class="w-fill overflow-hidden shadow-md shadow-gray-400 rounded-sm">
                                    ...
                                    <img
                                        ...
                                        alt=""
                                        class="w-full h-[30rem] object-cover transition duration-500 hover:scale-105 ease-out ">
                                </div>
                            </a>
                        @else
                            <x-Ui::image.empty-img/>
                        @endif
                        <div class="text-xs text-gray-600 flex gap-x-5 justify-between font-lex">
                            <div class="flex gap-x-5">
                                <div class="inline-flex items-center space-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         stroke-width="1.5" stroke="currentColor" class="size-3 text-gray-600">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div
                            class="indent-5 text-xs font-lex leading-loose">{{\Illuminate\Support\Str::words($row->body,30)}}</div>

                    </div>
                </div>
            @empty
                <x-Ui::image.empty_post/>
            @endforelse
            <x-Ui::modal.delete/>
        ...
        <div class="sm:w-3/12 w-auto scroll-smooth sm:px-0 px-2 space-y-10">
                    ...
                    <label for="">
                        ...
                        <span class="w-full">
                            <input type="text" placeholder="Search" wire:model.live="getListForm.searches"
                                   ...
                                   class="w-full h-11 border border-gray-200 rounded-sm focus:ring-0  bg-[#F9FAFB] text-gray-600 placeholder-gray-600 focus:border-pink-400 focus:placeholder-pink-600">
                        </span>

                        <span
                            class="absolute top-0 right-0 w-14 h-11 bg-[#F31A49] inline-flex items-center justify-center rounded-r-sm">
                ...
                <div class="bg-white flex-col flex gap-y-5 group ">
                    ...
                    @if($topPost)
                        @foreach($topPost as $row)
                            <div
                                class="w-full h-auto flex gap-x-2 hover:bg-slate-100 group animate__animated wow animate__backInRight "
                                data-wow-duration="3s">
                                <div class="w-2/6 overflow-hidden">
                                    <img
                                        src="{{ \Illuminate\Support\Facades\Storage::url('/images/' . ($row->image ?? 'default.png')) }}"
                                        alt="no image"
                                        class="w-full h-20 object-cover transition ease-in-out duration-300 hover:scale-105">
                                </div>
            ...
            <div class="text-2xl font-semibold underline scroll-smooth animate__animated wow bounceInRight"
                ...
                @if(session()->get('tenant_id')!='')
                    @if($tagfilter)
                        ...
                        <button wire:click="removeFilter({{$index}})" class="flex items-center justify-end">
                            <x-Ui::icons.icon :icon="'x-mark'" class="w-4 h-4"/>
                        </button>
                    </span>
